/**
 * original code from http://dev.px4.io/ros-mavros-offboard.html
 * Modified by Matt Schmittle to test ros mavros px4 install
 */
...
int main(int argc, char **argv)
{
	...
	if (landing){
        ...
        if (ros::Time::now() - start_time  > ros::Duration(50.0)&& landing){
